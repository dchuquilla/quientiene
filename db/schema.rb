...
ActiveRecord::Schema.define(version: 2021_08_25_155047) do
  ...
  create_table "ignored_proposals", force: :cascade do |t|
    t.bigint "user_id", null: false
    t.bigint "replacement_proposal_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["replacement_proposal_id"], name: "index_ignored_proposals_on_replacement_proposal_id"
    t.index ["user_id"], name: "index_ignored_proposals_on_user_id"
  end
  ...
  add_foreign_key "ignored_proposals", "replacement_proposals"
  add_foreign_key "ignored_proposals", "users"
